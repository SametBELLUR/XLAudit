...
If you're not sure what to ask your LLM, a ready-made prompt template is provided: [`PROMPT.md`](PROMPT.md). It instructs the LLM to produce a two-part analysis:
...
Copy the contents of `PROMPT.md`, append the report you generated, and send to your LLM.
...
├── PROMPT.md        # LLM analysis prompt template
